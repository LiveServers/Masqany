  ...
  return (
    <MainLayout>
      <MainLayout.TextSection>
        ...
        <MainLayout.Title>
          <MainLayout.Span>Rent</MainLayout.Span>al agreements
        </MainLayout.Title>
        <MainLayout.Description>
          Create, store, and manage rental agreements with ease. Masqany ensures all your lease
          terms are organized and accessible, giving landlords and tenants confidence in their
          commitments. Say goodbye to paper trails and hello to secure, digital documentation.
        </MainLayout.Description>

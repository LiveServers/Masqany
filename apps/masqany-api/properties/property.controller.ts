...
import { PropertyAccessDto, PropertyDetailsDto, PropertyLocationDetailsDto, PropertyResponse } from "./property.interface";
...
export const addPropertyLocationDetails = api(
  { expose: true, auth: true, method: "POST", path: "/property/v1/add-property-location-details/:propertyId" },
  async ({
    propertyId,
    data,
  }: {
...
export const addPropertyAccess = api(
  { expose: true, auth: true, method: "POST", path: "/property/v1/add-property-access/:propertyId" },
  async ({
    propertyId,
    data,
  }: {

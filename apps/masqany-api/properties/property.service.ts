...
import { KenyanCounties, PropertyAccessDto, PropertyDetailsDto, PropertyLocationDetailsDto, PropertyResponse, SupportedCountries } from "./property.interface";
...
const PropertyService = {
    ...
    addPropertyLocationDetails: async (data: PropertyLocationDetailsDto, id: string, propertyId: number): Promise<PropertyResponse> => {
    ...
    addPropertyAccess: async (data: PropertyAccessDto, id: string, propertyId: number): Promise<PropertyResponse> => {
